...
const ProgressDashboard = ({ stats, accuracy, progressPercent }: ProgressDashboardProps) => {
    ...
    <Card className={`p-4 space-y-4 transition-all duration-200 ${glowClass}`}>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="text-right">
          ...
          <p className="text-3xl font-bold text-foreground">{progressPercent.toFixed(0)}%</p>
